...
// Declare our timer variable globally and we can clear it anywhere in our code later 
//(not just when the timer ends, say when the game ends)
let timerInterval;
...
let scoreBoard = document.querySelector(".user-scores");
...
// ---------------------------------------------------- //
//
// Initialization Function: Function will look into local
//    storage, convert JSON object into JavaScript object,
...
// We declared it let's run it in the browser
initialize();
...
// ---------------------------------------------------- //
//
// Check Function: Tests if we have run out of question
//
// ---------------------------------------------------- //
function check() {
...
function showLeader() {
    ...
    // Clear the users and scores from <ul id='high scores'>
